      ...
      >
        ...
        {state === "Sign up" && isTextDataSubmited ? (
          ...
          <>
            {/* Check state */}
            {state !== "Login" && (
              // if state is Login so just input Email and password
              // Username
        ...
        {state === "Login" && (
          <p className="text-sm text-blue-600 my-4 cursor-pointer mt-4">
            Forgot password?
          </p>
        )}
        ...
        <button
          type="submit"
          className="bg-blue-600 text-white py-2 rounded-full w-full mt-4"
        >
          {state === "Login"
            ? "login"
            : isTextDataSubmited
